...
With the next cell I append imputed columns to the data frame. The nutrients diagnosis will be performed with imputed compositions.
...
highYieldersKmeans <- cascadeKM(highYieldersCentroids[, -1], 
                                inf.gr = 3, sup.gr = 6, criterion = "Calinski")
...
I consider `4 groups` established from clustering (`...`) corresponding to the second column. I can use the reference of the column or its name `4 groups` directly. I add it up to the centroids data frame.
