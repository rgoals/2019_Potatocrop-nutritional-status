...
The next chunk creates a table with cultivars, maturity classes and median clr values _i.e._ clr centroids for cultivars (the __S3 Table__ of the article).
...
s3table <- hy_clr %>% select(Cultivar, Maturity5) %>%
